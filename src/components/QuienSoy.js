    ...
    <article>
      <Card className="mb-4">
        <Card.Body>
          <h2>Quién soy</h2>
          <Card.Text>
            <p>La misión en el cuidado de mascotas en León de TRANQUILOPATITAS es ofrecer un servicio excepcional y personalizado para nuestros amigos peludos y sus familias.</p>
